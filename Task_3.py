...
text_file_1 = "filetext_1.txt"
text_file_2 = "filetext_2.txt"
real_pattern_1 = "Наприклад, розглянемо проблему виплати 98 копійок монетами номіналом 1, 2, 5, 10 і 25 копійок так, щоб загальна кількість монет було мінімально."
real_pattern_2 = "Крок 1. Ініціалізація рекомендаційної системи: задається"
fake_pattern = "search for non-existent text in the article"
